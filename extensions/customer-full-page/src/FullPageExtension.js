...
export default extension("customer-account.page.render", async (root, api) => {
  ...
  if (wishlists.length > 0) {
    let app = root.createComponent(Grid, {
    ...
    const buildWishList = () => {
      wishlists.forEach((wishlist) => {
        ...
        const priceTextComponent = root.createComponent(
          ...
          i18n.formatCurrency(wishlist.priceRange.minVariantPrice.amount, {
            currency: wishlist.priceRange.minVariantPrice.currencyCode,
          }),
        );
      ...
      const pageComponent = root.createComponent(Page, {
        title: "Wishlists",
      });
